...
const App = () => {
  return (<div>
    <Router>
        ...
        <Route exact path='/postwrite-list' component={PostWrite}/>
        <Route exact path='/postwrite-read' component={PostWrite}/>
        <Route exact path='/postwrite-remove' component={PostWrite}/>
